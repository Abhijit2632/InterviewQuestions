package com.cosmos.FlinkIntelijIdea.stream.first;
...
@Slf4j
public class KafkaConnectorTestApplication {
    public static void main(String[] args) throws Exception {
        final StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment();

        String inputTopic = "flinkTestDataStreamsInputTopic";
        String outputTopic = "flinkTestDataStreamsOutputTopic";
        String consumerGroup = "na";
        ...
        stringInputStream.map(new WordsCapitalizer()).sinkTo(sink).name("Kafka: " + outputTopic);
